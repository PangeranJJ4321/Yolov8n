...
- [X] **Hari 1-2:** Download dan eksplorasi dataset Roboflow
- [X] **Hari 3-4:** Setup environment Python, PyTorch, OpenCV
- [X] **Hari 5-7:** Install dan konfigurasi YOLOv8, DepthAnything V2

**Deliverables:**

- [X] Dataset Roboflow siap digunakan
- [X] Environment development berfungsi
...
- [X] **Hari 1-2:** Data preprocessing dan augmentation
- [X] **Hari 3-4:** Transfer learning dari pre-trained weights
- [X] **Hari 5-7:** Fine-tuning dan hyperparameter tuning

**Deliverables:**

- [X] Model YOLOv8 terlatih (.pt file)
- [X] Training logs dan metrics
- [X] Validation results (mAP@0.5 > 0.8)
