...
\begin{enumerate}
    \item Sistem deteksi \textit{real-time} berbasis \textbf{YOLOv8n-seg} dengan segmentasi instansi untuk akurasi area yang lebih tinggi.
